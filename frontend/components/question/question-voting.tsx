...
import { voteQuestion } from "@/app/question/[id]/voting-actions"
...
export function QuestionVoting({
  ...
  const handleVote = async (voteValue: 1 | -1) => {
    ...
    startTransition(async () => {
      try {
        const result = await voteQuestion(questionId, voteValue)
        ...
        if (result.removed) {
          ...
          toast({
            ...
            description: `Question ${voteValue === 1 ? "upvoted" : "downvoted"} successfully.`,
          })
        }
